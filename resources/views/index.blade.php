        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    {{-- first three categories as  carousel  --}}
                                            ...
                                            <div class="swiper-slide">
                                                <div class="row banner-content p-5">
                                                    <div class="content-wrapper col-md-7">
                                                        ...
                                                        <h3 class="display-4">{{ $item->category }}</h3>
                                                        <p>{{ $item->meta_description }}</p>
                                                        <a href="{{route('category.get.sub',$item->id)}}"
                                                            class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Shop
                                                            Now</a>
                                                    </div>
                                                    <div class="img-wrapper col-md-5">
                                                        <img src="{{ asset('storage/' . $item->image_url ?? 'images/default.png') }}"
                                                            class="img-fluid">
                       ...
                       @foreach ($category->skip(1)->take(2) as $index => $item)
                       <div class="banner-ad {{ $index % 2 === 0 ? 'bg-success-subtle block-2' : 'bg-danger block-3' }}"

                       
                           style="background:url('{{ asset($item->image_url ? 'storage/' . $item->image_url : 'images/ad-image-' . ($index + 1) . '.png') }}') no-repeat; background-position: right bottom">
                           
                           <div class="row banner-content p-5">
                               <div class="content-wrapper col-md-7">
                                   <div class="categories sale mb-3 pb-3">
                                       {{ $index == 0 ? '20% off' : '15% off' }}
                                   </div>
                                   <h3 class="banner-title">{{ $item->category }}</h3>
                                   <a href="{{route('category.get.sub',$item->id)}}" class="d-flex align-items-center nav-link">
