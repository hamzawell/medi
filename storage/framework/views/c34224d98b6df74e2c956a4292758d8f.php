            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="banner-blocks">
                            ...
                            <div class="banner-ad large bg-info block-1">
                                ...
                                <div class="swiper main-swiper">
                                    <div class="swiper-wrapper">
                                        <?php $__currentLoopData = $category->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="swiper-slide">
                                                <div class="row banner-content p-5">
                                                    <div class="content-wrapper col-md-7">
                                                        <div class="categories my-3">100% natural</div>
                                                        <h3 class="display-4"><?php echo e($item->category); ?></h3>
                                                        <p><?php echo e($item->meta_description); ?></p>
                                                        <a href="<?php echo e(route('category.get.sub',$item->id)); ?>"
                                                            class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Shop
                                                            Now</a>
                                                    </div>
                                                    <div class="img-wrapper col-md-5">
                                                        <img src="<?php echo e(asset('storage/' . $item->image_url ?? 'images/default.png')); ?>"
                                                            class="img-fluid">
                       ...
                       <?php $__currentLoopData = $category->skip(1)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <div class="banner-ad <?php echo e($index % 2 === 0 ? 'bg-success-subtle block-2' : 'bg-danger block-3'); ?>"

                       
                           style="background:url('<?php echo e(asset($item->image_url ? 'storage/' . $item->image_url : 'images/ad-image-' . ($index + 1) . '.png')); ?>') no-repeat; background-position: right bottom">
                           
                           <div class="row banner-content p-5">
                               <div class="content-wrapper col-md-7">
                                   <div class="categories sale mb-3 pb-3">
                                       <?php echo e($index == 0 ? '20% off' : '15% off'); ?>

                                   </div>
                                   <h3 class="banner-title"><?php echo e($item->category); ?></h3>
                                   <a href="<?php echo e(route('category.get.sub',$item->id)); ?>" class="d-flex align-items-center nav-link">
                                       Shop Collection <svg width="24" height="24">
...
<?php /**PATH C:\Users\kliff\Desktop\New folder\Medi-App\resources\views/index.blade.php ENDPATH**/ ?>